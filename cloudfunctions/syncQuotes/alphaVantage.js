...
function normalizeQuote(instrument, payload) {
  ...
  if (globalQuote && globalQuote['05. price']) {
    return {
      ...
      price: { amount: Number(globalQuote['05. price']).toFixed(4), currency: instrument.currency || 'USD' },
      asOf: globalQuote['07. latest trading day'] || new Date().toISOString().slice(0, 10),
